Classes in the `system.text.json` namespace don't tolerate comments in the JSON.
This file contains notes on the various "expected response" files.
...
Search results on CancerGov for the word breast, removing a different
...
only the first entry, from the metatag.description field
should be present.
...
Only one value for metatag.description field should be present.
