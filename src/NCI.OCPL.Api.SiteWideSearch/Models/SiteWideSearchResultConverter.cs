...
///    end-user output.
/// </summary>
public class SiteWideSearchResultConverter : JsonConverter<SiteWideSearchResult>
{
    /// <summary>
    /// Reads and converts JSON into a <see cref="SiteWideSearchResult"/>.
    /// </summary>
    /// <param name="reader">The reader.</param>
    /// <param name="typeToConvert">The type to convert.</param>
    /// <param name="options">The serializer options.</param>
    /// <returns>A <see cref="SiteWideSearchResult"/> deserialized from the JSON.</returns>
